            ...
            <div class="box">
                <div class="left-side d-inline-block">
                    ...
                    <div class="sikll ml-2 mt-2">
                        ...
                        <p class="para mb-1">
                            MS Office, Libre Office, Google <br>
                            Docs, EViews, Digital Marketing <br>
                            Windows, Linux, Motion Graphics <br>
                            Web Development (Prefessional <br>
                            Freelancer)
                        </p>
                    </div>
                ...
                <div class="right-side d-inline-block m-0 p-0 align-top">
                    <h2 class="name text-uppercase ml-3 my-3">Md. Samsuzzoha</h2>
                    <div class="about ml-3 mt-3">
                        <div class="heading-text text-uppercase">About Me</div>
                        <p class="para mb-1">
                            Multi-talented with knowledge of Accounting & Financial
                            Analysis, digital marketing, web development and others
                            consistently rewarded for success in planning and operational
                            improvements. Expert in IT and good in delivering effective
                            and engaging presentations to a variety of audiences.
                        </p>
                    </div>
